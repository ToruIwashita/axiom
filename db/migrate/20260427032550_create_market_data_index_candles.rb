class CreateMarketDataIndexCandles < ActiveRecord::Migration[8.1]
  def change
    create_table :market_data_index_candles do |t|
    ...
    add_index :market_data_index_candles, [ :symbol, :granularity, :ts ], unique: true
  end
end
