class CreateMarketDataFuturesCandles < ActiveRecord::Migration[8.1]
  def change
    create_table :market_data_futures_candles do |t|
    ...
    add_index :market_data_futures_candles, [ :symbol, :granularity, :ts ], unique: true
  end
end
